...
void NIA_DrawLine(HDC dst_hdc, const Line& line, HexColor color, int thickness = 1);

void NIA_FillEllipse(HDC dst_hdc, const Point& point, int radius, HexColor color, HexColor border_color = 0x000000, int thickness = 0);
